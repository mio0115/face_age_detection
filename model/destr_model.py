...
class ObjDetSplitTransformer(tf.keras.layers.Layer):
    def __init__(self, input_shape, num_cls: int, hidden_dim: int = 512, num_encoder_blocks: int = 1, num_decoder_blocks: int = 4, top_k: int = 5):
    ...
    def call(self, inputs):
        ...
        #x = tf.reshape(x + self._positional_encoding, shape=(batch_size, 49, self._hidden_dim))
