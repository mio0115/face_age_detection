...
docker run -it --rm --name $CONTAINER_NAME -p "$HOST_PORT:$CONTAINER_PORT" --gpus all --cpus="6" --memory="16g" -v $DATA_VOLUME_NAME:/workspace/data -v $MODEL_VOLUME_NAME:/workspace/models "$IMAGE_NAME:$IMAGE_TAG"
